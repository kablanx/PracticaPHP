  ...
  <div class="">
    ...
    <div>
      ...
      <ul class="pagination">
        ...
        <?php else : ?>
          <li class="page-item active paginacion"><a class="page-link" href="index.php?accion=listadoUsuariosRol&pagina=<?php echo $pagina - 1 ?>">&laquo;</a></li>
        <?php endif; ?>
        ...
        for ($i = 1; $i <= $numeroPaginas; $i++) {
          if ($pagina == $i) {
            echo "<li class='page-item paginacion'><a class='page-link' href='index.php?accion=listadoUsuariosRol&pagina=$i'>$i</a></li>";
          } else {
            echo "<li class='active page-item paginacion'><a class='page-link' href='index.php?accion=listadoUsuariosRol&pagina=$i'>$i</a></li>";
          }
        }
        ?>
        ...
        <?php else : ?>
          <li class="page-item active paginacion"><a class="page-link" href="index.php?accion=listadoUsuariosRol&pagina=<?php echo $pagina + 1 ?>">&raquo;</a></li>
        <?php endif; ?>
